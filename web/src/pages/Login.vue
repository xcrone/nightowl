...
const form = reactive({ email: '', password: '', error: null, submitting: false })
  ...
  <div class="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
    ...
    >
      ...
      <input
        ...
        type="email"
        required
        class="mb-4 w-full rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
      />
