...
//     defaultSort,        // e.g. '-last_triggered' (newest-first by default)
...
export const aggregateConfig = {
  ...
  jobs: {
    ...
    countLabel: 'Jobs',
    rowKey: 'job_class',
    // Newest-first keys on Finished, not the derived Triggered column: only
    // last_finished is a real column the api can ORDER BY.
    defaultSort: '-last_finished',
    searchable: true,
